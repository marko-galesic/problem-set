...
export default function GuideChatPopover({
  ...
  return (
    <Dialog
      ...
      onClose={onClose}
      maxWidth={false}
      PaperProps={{ className: 'guide-chat-popover' }}
    >
      <DialogTitle className="guide-chat-popover-header">
        <span>Guide me</span>
        <IconButton
      ...
      <DialogContent className="guide-chat-popover-content">
      ...
      <DialogActions className="guide-chat-popover-footer">
        {error && (
